...
let
   menu_bin = "olynix-menu";
in
{
  environment.systemPackages = with pkgs; [


    (writeShellScriptBin "${menu_bin}" ''
    ...
    present_terminal() {
      olynix-launch-floating-terminal-with-presentation $1
    }

    open_in_editor() {
      notify-send "Editing config file" "$1"
      olynix-launch-editor "$1"
    }
    ...
    show_learn_menu() {
      ...
      *Omarchy*) olynix-launch-webapp "https://learn.omacom.io/2/the-omarchy-manual" ;;
      *Hyprland*) olynix-launch-webapp "https://wiki.hypr.land/" ;;
      *NixOS*) olynix-launch-webapp "https://wiki.nixos.org/wiki/NixOS_Wiki" ;;
      *Bash*) olynix-launch-webapp "https://devhints.io/bash" ;;
      *Neovim*) olynix-launch-webapp "https://www.lazyvim.org/keymaps" ;;
      *) show_main_menu ;;
      esac
    }
    ...
    show_screenshot_menu() {
      ...
      *Region*) olynix-cmd-screenshot ;;
      *Window*) olynix-cmd-screenshot window ;;
      *Display*) olynix-cmd-screenshot output ;;
      *) show_capture_menu ;;
      esac
    }
    ...
    show_toggle_menu() {
      ...
      *Screensaver*) olynix-toggle-screensaver ;;
    ...
    show_style_menu() {
      ...
      *Screensaver*) open_in_editor ~/.local/share/olynix/screensaver.txt ;;
    ...
    show_install_menu() {
      ...
      *Web*) present_terminal olynix-webapp-install ;;
    ...
    show_remove_menu() {
      ...
      *Web*) present_terminal olynix-webapp-remove ;;
    ...
    show_system_menu() {
      ...
      *Lock*) olynix-lock ;;
      *Screensaver*) olynix-launch-screensaver force ;;
